...
export const publicationData: Publication[] = [
  // If you don't want to show publications, just make the array empty.
  {
    ...
    authors: "<u>Wataru Ikeda</u>, Kazuki Yano, Ryosuke Takahashi, Jaesung Lee, Keigo Shibata, Jun Suzuki",
    ...
    imageUrl:
     "https://gyazo.com/86ec825a4bed02441b27c1e56fcbf400",
  },
  {
    year: "2025",
    conference: "言語処理学会第31回年次大会",
    title: "Transformer LLMにおける層単位のFFN層の重要度検証",
    authors: "<u>池田航</u>, 矢野一樹, 高橋良允, 李宰成, 柴田圭吾, 鈴木潤",
  ...
  },
  {
    ...
    authors: "李宰成, 矢野一樹, 高橋良允, 柴田圭吾, <u>池田航</u>, 鈴木潤",
  ...
  },
  {
    ...
    authors: "柴田圭吾, 高橋良允, 矢野一樹, 李宰成, <u>池田航</u>, 鈴木潤",
